...
np.random.seed(42)
subset_task_indices = np.random.randint(0, len(X_trains_1), size=2_000)
X_trains_1 = [X_trains_1[i] for i in subset_task_indices]
y_trains_1 = [y_trains_1[i] for i in subset_task_indices]
...
for epoch in range(num_epochs):
    ...
    torch.save(model.state_dict(), 'model_rag_im_subset_tasks.pth')
